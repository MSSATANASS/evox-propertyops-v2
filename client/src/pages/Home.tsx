  ...
  return <div className="evox-shell min-h-screen text-[#f1f4ed]">
    ...
    <div className="relative z-10 mx-auto grid max-w-[1600px] gap-5 p-4 lg:grid-cols-[265px_minmax(0,1fr)] lg:p-6">
      ...
      <main className="min-w-0">
        ...
        <section className="evox-card mt-5 rounded-2xl p-4"><div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center"><div><p className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[.15em] text-[#c9ff4a]"><Layers3 size={14} />Suite Evox para Mérida</p><p className="mt-2 text-sm text-[#94a39b]">Accede a flujos separados para experiencias turísticas, cambios de ocupación y coordinación de proveedores. Cada módulo conserva datos aislados y control humano.</p></div><div className="flex shrink-0 flex-wrap gap-2"><Link href="/tienda" className="evox-ghost inline-flex items-center gap-2 px-3 py-2 text-xs"><Store size={14} />Tienda</Link><Link href="/tourrun" className="evox-ghost inline-flex items-center gap-2 px-3 py-2 text-xs"><MapPin size={14} />TourRun</Link><Link href="/turnover" className="evox-ghost inline-flex items-center gap-2 px-3 py-2 text-xs"><ClipboardList size={14} />TurnoverOps</Link><Link href="/vendors" className="evox-button inline-flex items-center gap-2 px-3 py-2 text-xs"><Wrench size={14} />VendorOps</Link></div></div></section>
